 ...
 * \sa NET_ReceiveDatagram
 *)
function NET_WaitUntilInputAvailable(vsockets: PPointer; numsockets: cint; timeout: cint32): cint; cdecl;
  external NET_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_NET_WaitUntilInputAvailable' {$ENDIF} {$ENDIF};
