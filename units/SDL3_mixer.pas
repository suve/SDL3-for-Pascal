 ...
 * \sa Mix_QuerySpec
 *}
function Mix_OpenAudio(devid: TSDL_AudioDeviceID; const spec: PSDL_AudioSpec): cbool; cdecl;
 ...
 * \sa Mix_OpenAudio
 *}
function Mix_QuerySpec(frequency: pcint; format: PSDL_AudioFormat; channels: pcint): cbool; cdecl;
 ...
 * \sa Mix_FreeChunk
 *}
function Mix_LoadWAV_IO(src: PSDL_IOStream; closeio: cbool): PMix_Chunk; cdecl;
 ...
 * \sa Mix_FreeMusic
 *}
function Mix_LoadMUS_IO(src: PSDL_IOStream; closeio: cbool): PMix_Music; cdecl;
 ...
 * \sa Mix_FreeMusic
 *}
function Mix_LoadMUSType_IO(src: PSDL_IOStream; mtype: TMix_MusicType; closeio: cbool): PMix_Music; cdecl;
 ...
 * \sa Mix_GetChunkDecoder
 *}
function Mix_HasChunkDecoder(const name: PAnsiChar): cbool; cdecl;
 ...
 * \sa Mix_GetMusicDecoder
 *}
function Mix_HasMusicDecoder(const name: PAnsiChar): cbool; cdecl;
...
type
  ...
  PMix_EffectFunc = ^TMix_EffectFunc;
  PPMix_EffectFunc = ^PMix_EffectFunc;
 ...
 *}
type
  TMix_EffectDone = procedure(chan: cint; udata: Pointer); cdecl;
  PMix_EffectDone = ^TMix_EffectDone;
  PPMix_EffectDone = ^PMix_EffectDone;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_UnregisterEffect(channel: cint; f: TMix_EffectFunc): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_UnregisterAllEffects(channel: cint): cbool; cdecl;
 ...
 * \sa Mix_SetDistance
 *}
function Mix_SetPanning(channel: cint; left, right: cuint8): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_SetPosition(channel: cint; angle: cint16; distance: cuint8): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_SetDistance(channel: cint; distance: cuint8): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_SetReverseStereo(channel, flip: cint): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_GroupChannel(which, tag: cint): cbool; cdecl;
 ...
 *
 * \param first the first channel to set the tag on.
 * \param last the last channel to set the tag on, inclusive.
 * \param tag an arbitrary value to assign a channel.
 * \returns true on success or false on failure; call SDL_GetError() for more
 *          information.
 *
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_PlayMusic(music: PMix_Music; loops: cint): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_FadeInMusic(music: PMix_Music; loops, ms: cint): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_FadeInMusicPos(music: PMix_Music; loops, ms: cint; position: cdouble): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_FadeOutMusic(ms: cint): cbool; cdecl;
 ...
 * \sa Mix_ResumeMusic
 *}
function Mix_PausedMusic(): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_ModMusicJumpToOrder(order: cint): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_StartTrack(music: PMix_Music; track: cint): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_SetMusicPosition(position: cdouble): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_PlayingMusic(): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_SetSoundFonts(const paths: PAnsiChar): cbool; cdecl;
 ...
 *}
function Mix_EachSoundFont(func: TMix_EachSoundFontCallback; data: Pointer): cbool; cdecl;
 ...
 * \since This function is available since SDL_mixer 3.0.0.
 *}
function Mix_SetTimidityCfg(const path: PAnsiChar): cbool; cdecl;
